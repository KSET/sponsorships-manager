class EventTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_type.save
        format.html { redirect_to @event_type, notice: 'EventType was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @event_type.update_attributes(params[:event_type])
        format.html { redirect_to @event_type, notice: 'EventType was successfully updated.' }
        format.json { head :ok }
      else
